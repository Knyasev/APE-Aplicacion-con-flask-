...
@api_sucursal.route("/sucursal/usuario/<int:usuario_id>", methods=["GET"])
def get_sucursal_by_usuario(usuario_id):
    try:
        sucursal = sucursalC.get_sucursal_by_usuario(usuario_id)
        return make_response(
            jsonify({"msg": "OK", "code": 200, "datos": sucursal.serialize}),
            200
        )
